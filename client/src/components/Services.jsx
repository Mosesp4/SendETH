            ...
            <div className='flex-1 flex flex-col justify-start items-center '>
              <ServiceCard
                ...
                <ServiceCard
                  ...
                  icon={<FaUserCircle fontSize={21} className='text-white' />}
                  subtitle="Our app has a user-friendly interface, making it easy for users of all 
                  technical skill levels to send and receive Ethereum."
                />
